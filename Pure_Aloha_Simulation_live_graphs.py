...
# ax1.plot(node_axis, G, label='G(t)')
# ax1.scatter(node_axis, G, label='G(t)')
# ax2.plot(node_axis, S, label='S(t)')
# ax2.scatter(node_axis, S, label='S(t)')
# ax3.plot(node_axis, collision_rate, label='Collision Rate')
# ax3.scatter(node_axis, collision_rate, label='Collision Rate')
# ax4.plot(G, S, label='S(t)')
# ax4.scatter(G, S, label='S(t)')
...
# ax6.plot(node_axis, nodes_selected, label='Nodes_selected to Transmit')
# ax6.scatter(node_axis, nodes_selected, label='Nodes_selected to Transmit')
...
ax1.plot(node_axis, G, label='G(t)', color = 'blue')
# ax1.scatter(node_axis, G, label='G(t)', color = 'blue')
ax2.plot(node_axis, S, label='S(t)', color = 'blue')
# ax2.scatter(node_axis, S, label='S(t)', color = 'blue')
ax3.plot(node_axis, collision_rate, label='Collision Rate', color = 'blue')
# ax3.scatter(node_axis, collision_rate, label='Collision Rate', color = 'blue')
ax4.plot(G, S, label='S(t)', color = 'blue')
# ax4.scatter(G, S, label='S(t)', color = 'blue')
=======
...
=======
        S.append(T_payload * successful_transmissions/node_step)
>>>>>>> f024348b50d3669833f469bb85e47900c46ef58f
...
=======
print(f'Time: {time/3600000} hours')
>>>>>>> f024348b50d3669833f469bb85e47900c46ef58f
